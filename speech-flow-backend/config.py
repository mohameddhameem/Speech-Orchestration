...
class Settings:
    ...
    RESULTS_CONTAINER_NAME: Final[str] = os.getenv("RESULTS_CONTAINER_NAME", "results")
    ...
    SERVICEBUS_FQDN: Final[str] = os.getenv(
        "SERVICEBUS_FQDN", f"{os.getenv('SERVICEBUS_NAMESPACE', 'localhost')}.servicebus.windows.net"
    )
    ...
    AZURE_OPENAI_ENDPOINT: Final[str] = os.getenv("AZURE_OPENAI_ENDPOINT", "https://my-resource.openai.azure.com/")
    ...
    HF_SUMMARIZATION_MODEL: Final[str] = os.getenv("HF_SUMMARIZATION_MODEL", "facebook/bart-large-cnn")
    HF_TRANSLATION_MODEL: Final[str] = os.getenv("HF_TRANSLATION_MODEL", "Helsinki-NLP/opus-mt-{src}-{tgt}")
